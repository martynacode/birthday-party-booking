...
function FoodAndAllergyForm({ onContinue, packageChoice }) {
  ...
  const allergenOptions = [
    ...
    },
    {
      ...
      label: "🥛 Dairy",
      message:
        "Pizza, pasta and ice cream contain dairy. We can offer dairy-free alternatives — goujons or hot dogs as a main, and vegan vanilla ice cream as a dessert.",
    },
    {
      id: "eggs",
      label: "🥚 Eggs",
    ...
    },
    {
      ...
      label: "🌱 Vegetarian",
      message:
        "Cheese pizza and tomato pasta are both vegetarian-friendly. Fruit skewers are vegetarian for dessert.",
    },
    {
      id: "vegan",
      label: "🌿 Vegan",
      message:
        "We can offer vegan pasta (without cheese) and fruit skewers for dessert. Please mention specific guests to the host on the day.",
    },
    {
      id: "other",
      label: "❓ Other",
  ...
  return (
    <div className="form-page">
      <div className="form-container">
        {/* Heading and step indicator at the top of the page*/}
        <h2> Food &amp; Allergies</h2>
        <p className="form-subtitles">
